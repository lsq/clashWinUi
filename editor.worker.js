(() => {
  ...
  function f(...e) {
    ...
    return (
      (function (e, t) {
        if (a) for (const n of e) a.setParent(n, t);
      })(e, t),
      t
    );
  }
  ...
  class C {
    constructor(e) {
      ((this.element = e),
        (this.next = C.Undefined),
        (this.prev = C.Undefined));
    }
  }
  ...
  class L {
    ...
    _remove(e) {
      if (e.prev !== C.Undefined && e.next !== C.Undefined) {
        ...
        e.prev === C.Undefined && e.next === C.Undefined
          ? ((this._first = C.Undefined), (this._last = C.Undefined))
          : e.next === C.Undefined
            ? ((this._last = this._last.prev), (this._last.next = C.Undefined))
            : e.prev === C.Undefined &&
              ((this._first = this._first.next),
              (this._first.prev = C.Undefined));
      this._size -= 1;
    }
    *[Symbol.iterator]() {
      let e = this._first;
  ...
  let V;
  void 0 !== R.vscode && void 0 !== R.vscode.process
    ? (V = R.vscode.process)
    : "undefined" != typeof process && (V = process);
  const I =
    "string" ==
      typeof (null === (l = null == V ? void 0 : V.versions) || void 0 === l
        ? void 0
        : l.electron) && "renderer" === V.type;
  if ("object" != typeof navigator || I)
    if ("object" == typeof V) {
      ((E = "win32" === V.platform),
        (y = "darwin" === V.platform),
        (A = "linux" === V.platform),
        (w = A && !!V.env.SNAP && !!V.env.SNAP_REVISION),
        (b = S),
        (O = S));
  ...
  class H {
    constructor(e) {
      ...
      ((this._disposed = !1),
        ...
        (this._perfMon = (
          null === (t = this._options) || void 0 === t ? void 0 : t._profName
        )
          ? new q(this._options._profName)
          : void 0));
    }
    get event() {
      return (
        this._event ||
          (this._event = (e, t, n) => {
            ...
            const o =
              ...
              a = g(() => {
                if (
                  (o && o(),
                  !this._disposed &&
                    (s(), this._options && this._options.onLastListenerRemove))
                ) {
            ...
            return (
              n instanceof _ ? n.add(a) : Array.isArray(n) && n.push(a),
              a
            );
          }),
        this._event
      ...
      const i = new H({
        onFirstListenerAdd: () => {
          ((n = String(++this._lastSentReq)),
            ...
            this._send(new ee(this._workerId, n, e, t)));
        },
        onLastListenerRemove: () => {
          (this._pendingEmitters.delete(n),
            this._send(new ne(this._workerId, n)),
            (n = null));
        },
      });
      return i.event;
      ...
      this._handler.handleMessage(e.method, e.args).then(
        ...
        (e) => {
          (e.detail instanceof Error && (e.detail = n(e.detail)),
            this._send(new J(this._workerId, t, void 0, n(e))));
        },
      );
    }
  ...
  function oe(e, t, n) {
    ...
    let s = {};
    for (const t of e)
      se(t) ? (s[t] = r(t)) : re(t) ? (s[t] = n(t, void 0)) : (s[t] = i(t));
    return s;
  }
  class ae {
    constructor(e, t) {
    ...
    initialize(e, t, n, i) {
      ...
      return this._requestHandlerFactory
        ? ((this._requestHandler = this._requestHandlerFactory(r)),
          Promise.resolve(W(this._requestHandler)))
        : (t &&
    ...
    digest() {
      return (
        this._finished ||
          ...
          this._wrapUp()),
        me(this._h0) + me(this._h1) + me(this._h2) + me(this._h3) + me(this._h4)
      );
    }
    _wrapUp() {
      ((this._buff[this._buffLen++] = 128),
        ce(this._buff, this._buffLen),
        this._buffLen > 56 && (this._step(), ce(this._buff)));
    ...
    _step() {
      ...
      for (let t = 0; t < 80; t++)
        (t < 20
          ...
          (r = (de(s, 5) + n + u + i + e.getUint32(4 * t, !1)) & 4294967295),
          (u = l),
          (l = a),
          (a = de(o, 30)),
          (o = s),
  ...
  class Se {
    constructor(e, t, n = null) {
      ...
      const [i, r, s] = Se._getElements(e),
        [o, a, l] = Se._getElements(t);
    ...
    ElementsAreStrictEqual(e, t) {
      ...
      return (
        Se._getStrictElement(this._originalSequence, e) ===
        Se._getStrictElement(this._modifiedSequence, t)
      );
    }
    ...
    ComputeDiffRecursive(e, t, n, i, r) {
      ...
      if (!r[0]) {
        ...
        return (
          (o = r[0]
            ? [new le(l + 1, t - (l + 1) + 1, u + 1, i - (u + 1) + 1)]
    ...
    ComputeRecursionPoint(e, t, n, i, r, s, o) {
      ...
      for (let N = 1; N <= m / 2 + 1; N++) {
        let m = 0,
          E = 0;
        ((u = this.ClipDiagonalBound(p - N, N, p, f)),
          (h = this.ClipDiagonalBound(p + N, N, p, f)));
        for (let e = u; e <= h; e += 2) {
          ((a =
            e === u || (e < h && g[e - 1] < g[e + 1])
              ? g[e + 1]
        ...
        if (
          ...
          !this.ContinueProcessingPredicate(m, y)
        )
          return (
            (o[0] = !0),
            (r[0] = m),
            ...
            y > 0 && N <= 1448
              ...
              : (e++, n++, [new le(e, t - e + 1, n, i - n + 1)])
          );
        ((d = this.ClipDiagonalBound(C - N, N, C, f)),
          (c = this.ClipDiagonalBound(C + N, N, C, f)));
        for (let m = d; m <= c; m += 2) {
          ((a =
            m === d || (m < c && _[m - 1] >= _[m + 1])
              ? _[m + 1] - 1
          ...
          if (((_[m] = a), b && Math.abs(m - p) <= N && a <= g[m]))
            return (
              (r[0] = a),
              (s[0] = l),
              f >= g[m] && N <= 1448
        ...
        if (N <= 1447) {
          ...
          ((e[0] = p - u + 1),
            Ce.Copy2(g, u, e, 1, h - u + 1),
            this.m_forwardHistory.push(e),
            (e = new Int32Array(c - d + 2)),
            (e[0] = C - d + 1),
            Ce.Copy2(_, d, e, 1, c - d + 1),
    ...
    ConcatenateChanges(e, t) {
      ...
      if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
        ...
        return (
          Ce.Copy(e, 0, i, 0, e.length - 1),
          (i[e.length - 1] = n[0]),
          Ce.Copy(t, 1, i, e.length, t.length - 1),
          i
        );
      }
      {
        ...
        return (
          Ce.Copy(e, 0, n, 0, e.length),
          Ce.Copy(t, 0, n, e.length, t.length),
          n
        );
      }
    }
        ...
        if (o === u - 1 || 1 === a);
          ...
          if (
            ...
            if (r.length > 2) {
              ...
              (-1 === e
                ? ((r = ""), (s = 0))
                : ((r = r.slice(0, e)), (s = r.length - 1 - r.lastIndexOf(n))),
                (o = u),
                (a = 0));
              continue;
            }
  ...
  function Ie(e, t) {
    if (null === t || "object" != typeof t)
      throw new Me("pathObject", "Object", t);
  ...
  const Pe = {
      resolve(...e) {
        ...
        for (let r = e.length - 1; r >= -1; r--) {
          ...
          if (i) {
            if (t.length > 0) break;
          } else if (((n = `${s.slice(a)}\\${n}`), (i = u), u && t.length > 0))
            break;
        }
        return (
          (n = Ve(n, !i, "\\", Oe)),
      ...
      normalize(e) {
        ...
        if (Oe(s))
          ...
          Re(s) &&
            ...
            ((n = e.slice(0, 2)),
            (i = 2),
            t > 2 && Oe(e.charCodeAt(2)) && ((r = !0), (i = 3)));
        let o = i < t ? Ve(e.slice(i), !r, "\\", Oe) : "";
        return (
          0 !== o.length || r || (o = "."),
          o.length > 0 && Oe(e.charCodeAt(t - 1)) && (o += "\\"),
      ...
      isAbsolute(e) {
        ...
        return (
          Oe(n) ||
          (t > 2 && Re(n) && e.charCodeAt(1) === ve && Oe(e.charCodeAt(2)))
        );
      },
      join(...e) {
      ...
      relative(e, t) {
        ...
        if (c !== h) {
          ...
          (o > h && (e.charCodeAt(r + c) === we ? (d = c) : 2 === c && (d = 3)),
            -1 === d && (d = 0));
        }
        let m = "";
        for (c = r + d + 1; c <= s; ++c)
          (c !== s && e.charCodeAt(c) !== we) ||
            (m += 0 === m.length ? ".." : "\\..");
        return (
          (a += d),
          m.length > 0
            ? `${m}${i.slice(a, l)}`
            : (i.charCodeAt(a) === we && ++a, i.slice(a, l))
        );
      },
      toNamespacedPath(e) {
      ...
      dirname(e) {
        ...
        if (Oe(r)) {
          ...
          Re(r) &&
            e.charCodeAt(1) === ve &&
            ((n = t > 2 && Oe(e.charCodeAt(2)) ? 3 : 2), (i = n));
        let s = -1,
          o = !0;
        for (let n = t - 1; n >= i; --n)
      ...
      parse(e) {
        ...
        let i = 0,
          r = e.charCodeAt(0);
        if (1 === n)
          return Oe(r) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
        if (Oe(r)) {
      ...
      relative(e, t) {
        ...
        if (a === s)
          if (r > s) {
            ...
            i > s &&
              (e.charCodeAt(1 + a) === Ae ? (o = a) : 0 === a && (o = 0));
        let l = "";
        for (a = 1 + o + 1; a <= n; ++a)
          (a !== n && e.charCodeAt(a) !== Ae) ||
            (l += 0 === l.length ? ".." : "/..");
  ...
  ("win32" === Ee ? Pe.normalize : xe.normalize,
    "win32" === Ee ? Pe.resolve : xe.resolve,
    "win32" === Ee ? Pe.relative : xe.relative,
    "win32" === Ee ? Pe.dirname : xe.dirname,
    "win32" === Ee ? Pe.basename : xe.basename,
    "win32" === Ee ? Pe.extname : xe.extname,
    "win32" === Ee ? Pe.sep : xe.sep);
  const ke = /^\w[\w\d+.-]*$/,
    De = /^\//,
    Fe = /^\/\//;
  ...
  class We {
    ...
    with(e) {
      ...
      return (
        void 0 === t ? (t = this.scheme) : null === t && (t = Be),
        void 0 === n ? (n = this.authority) : null === n && (n = Be),
        void 0 === i ? (i = this.path) : null === i && (i = Be),
        void 0 === r ? (r = this.query) : null === r && (r = Be),
        void 0 === s ? (s = this.fragment) : null === s && (s = Be),
        t === this.scheme &&
        n === this.authority &&
        i === this.path &&
        r === this.query &&
    ...
    static parse(e, t = !1) {
      ...
      return n
        ...
        : new je(Be, Be, Be, Be, Be);
    }
    static file(e) {
      let t = Be;
      if ((x && (e = e.replace(/\\/g, qe)), e[0] === qe && e[1] === qe)) {
        const n = e.indexOf(qe, 2);
        -1 === n
          ? ((t = e.substring(2)), (e = qe))
          : ((t = e.substring(2, n)), (e = e.substring(n) || qe));
      }
      ...
      if (e) {
        if (e instanceof We) return e;
        {
          ...
          return (
            ...
            (t._fsPath = e._sep === $e ? e.fsPath : null),
            t
          );
        }
      }
  ...
  class je extends We {
    ...
    toJSON() {
      ...
      return (
        this._fsPath && ((e.fsPath = this._fsPath), (e._sep = $e)),
  ...
  function Ye(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      35 === i || 63 === i
        ? (void 0 === t && (t = e.substr(0, n)), (t += Ge[i]))
        : void 0 !== t && (t += e[n]);
    }
    return void 0 !== t ? t : e;
  }
  ...
  class nt {
    ...
    static intersectRanges(e, t) {
      ...
      return (
        ...
        n > r || (n === r && i > s) ? null : new nt(n, i, r, s)
      );
    }
    equalsRange(e) {
    ...
    static lift(e) {
      return e
        ? new nt(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn)
        : null;
    }
    static isIRange(e) {
      return (
    ...
    static createFromDiffResult(e, t, n, i, r, s, o) {
      ...
      if (
        ...
        for (let e = 0, t = l.length; e < t; e++)
          d.push(ot.createFromDiffChange(l[e], s, a));
      }
  ...
  class lt {
    constructor(e, t, n) {
      ((this.shouldComputeCharChanges = n.shouldComputeCharChanges),
        ...
        (this.original = new rt(e)),
        (this.modified = new rt(t)),
        (this.continueLineDiff = dt(n.maxComputationTime)),
        (this.continueCharDiff = dt(
          ...
          if (e !== t) {
            {
              ...
              (n > 1 || o > 1) &&
                this._pushTrimWhitespaceCharChange(i, r + 1, 1, n, s + 1, 1, o);
            }
            {
              let n = ht(e, 1),
                o = ht(t, 1);
              ...
              (n < a || o < l) &&
                this._pushTrimWhitespaceCharChange(i, r + 1, n, a, s + 1, o, l);
            }
          }
          (r++, s++);
        }
    ...
    _pushTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
      ...
      let a;
      (this.shouldComputeCharChanges && (a = [new ot(t, n, t, i, r, s, r, o)]),
        e.push(new at(t, t, r, r, a)));
    }
    _mergeTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
      ...
      return (
        ...
        this.shouldComputeCharChanges &&
          l.charChanges &&
          l.charChanges.push(new ot(t, n, t, i, r, s, r, o)),
        !0)
      );
    }
  }
      ...
      for (const e of t)
        (this._acceptDeleteRange(e.range),
          this._acceptInsertText(
            new tt(e.range.startLineNumber, e.range.startColumn),
            e.text,
          ));
  ...
  function Lt(e, t, n, i, r = Ct) {
    if (n.length > r.maxLen) {
      ...
      return (
        s < 0 ? (s = 0) : (i += s),
        Lt(e, t, (n = n.substring(s, e + r.maxLen / 2)), i, r)
      );
    }
    const s = Date.now(),
      o = e - 1 - i;
  ...
  class bt {
    constructor(e) {
      ...
      ((this._defaultValue = t),
        (this._asciiMap = bt._createAsciiMap(t)),
        (this._map = new Map()));
    }
      ...
      for (let r = 1, s = e.getLineCount(); r <= s; r++) {
        ...
        for (; a < o; ) {
          ...
          if (13 === h) {
            ...
            let t;
            (91 === o ? ((c = !0), (t = 0)) : (t = n.get(o)),
              1 === t ? (e = !0) : (h = 13));
          } else ((h = t.nextState(h, o)), 0 === h && (e = !0));
          (e && ((h = 1), (d = !1), (c = !1), (f = !1), (l = a + 1), (u = o)),
            a++);
        }
  ...
  class Ot {
    ...
    get onCancellationRequested() {
      return this._isCancelled
        ? Mt
        : (this._emitter || (this._emitter = new H()), this._emitter.event);
    }
    dispose() {
  ...
  (!(function () {
    ...
    for (const e of t) {
      ...
      if (
        ...
        if (((n[a] = !0), !l))
          throw new Error(
            `String representation missing for key code ${a} around scan code ${o}`,
          );
  ...
  class wn extends nt {
    ...
    setEndPosition(e, t) {
      return 0 === this.getDirection()
        ? new wn(this.startLineNumber, this.startColumn, e, t)
        : new wn(e, t, this.startLineNumber, this.startColumn);
    }
    getPosition() {
    ...
    setStartPosition(e, t) {
      return 0 === this.getDirection()
        ? new wn(e, t, this.endLineNumber, this.endColumn)
        : new wn(this.endLineNumber, this.endColumn, e, t);
    }
    static fromPositions(e, t = e) {
  ...
  (!(function (e) {
    ...
    (function (e) {
      ((e[(e.acceptSuggestionOnCommitCharacter = 0)] =
        ...
        (e[(e.unfoldOnClickAfterEndOfLine = 41)] =
        ...
        (e[(e.renderLineHighlightOnlyWhenFocus = 85)] =
          "renderLineHighlightOnlyWhenFocus"),
        (e[(e.renderValidationDecorations = 86)] =
          "renderValidationDecorations"),
        (e[(e.renderWhitespace = 87)] = "renderWhitespace"),
        (e[(e.revealHorizontalRightPadding = 88)] =
        ...
        (e[(e.suggestOnTriggerCharacters = 108)] =
        ...
        (e[(e.wordWrapBreakAfterCharacters = 117)] =
          "wordWrapBreakAfterCharacters"),
        (e[(e.wordWrapBreakBeforeCharacters = 118)] =
  ...
  class On extends _t {
    ...
    getWordAtPosition(e, t) {
      ...
      return n
        ? new nt(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn)
        : null;
    }
    words(e) {
      const t = this._lines,
    ...
    computeMoreMinimalEdits(e, t) {
      return Kn(this, void 0, void 0, function* () {
        ...
        t = t.slice(0).sort((e, t) => {
          if (e.range && t.range)
            return nt.compareRangesUsingStarts(e.range, t.range);
          ...
          if (e)
            for (let n of e.words(s))
              if (
                n !== t &&
                isNaN(Number(n)) &&
                (o.add(n), o.size > Tn._suggestionsLimit)
              )
                break e;
        }
        return {
    ...
    loadForeignModule(e, t, n) {
      ...
      return this._foreignModuleFactory
        ? ((this._foreignModule = this._foreignModuleFactory(r, t)),
          Promise.resolve(W(this._foreignModule)))
