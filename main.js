...
(() => {
  ...
  ((() => {
    ...
    ((global.__static = n(17)
      .join(__dirname, "/static")
      .replace(/\\/g, "\\\\")),
      ("darwin" === process.platform || "linux" === process.platform) && O(),
      host.app.disableHardwareAcceleration(),
      host.app.commandLine.appendSwitch("disable-features", "OutOfBlinkCors"),
      "darwin" === process.platform && host.app.dock.hide());
    var P,
      I = [],
    ...
    function D() {
      ...
      ((g = new host.BrowserWindow({
        ...
        minWidth: 850,
        minHeight: 603,
        backgroundColor: host.nativeTheme.shouldUseDarkColors
          ? "#272531"
          : "#f5f5f5",
        useContentSize: true,
        show: false,
        ...
        g.webContents.on("will-navigate", function (types) {
              ...
              return p().wrap(function (self) {
                for (;;) {
                  switch ((self.prev = self.next)) {
                    case 0:
                      if (
                        ((reason = err.reason), "darwin" !== process.platform)
                      ) {
                        /** @type {number} */
                        self.next = 3;
                        break;
                    ...
                    case 3:
                      ...
                      return (
                        ...
                        (self.next = 7),
                        host.dialog.showMessageBox(g, par)
                      );
                    case 7:
        ...
        host.ipcMain.handle(
          "start-download",
          function (dataAndEvents, deepDataAndEvents, minX) {
            g.webContents.downloadURL(deepDataAndEvents);
            /** @type {Function} */
            x = minX;
          },
        ),
        g.webContents.session.on(
          "will-download",
          function (dataAndEvents, model, deepDataAndEvents) {
            if (x) {
              model.setSavePath(x);
                  ...
                  if ("progressing" === dataAndEvents) {
                    if (model.isPaused()) {
                      ...
                      g.webContents.send(
                        "download",
                        "downloading",
                        model.getReceivedBytes() / model.getTotalBytes(),
                      );
                    }
                  }
                }
        ...
        g.on("show", function () {
          ("darwin" === process.platform && host.app.dock.show(),
            g.webContents.send("window-event", "show"));
        }),
        g.on("close", function (e) {
          if (host.app.isQuiting) {
            ...
            if (
              (e.preventDefault(),
              "darwin" === process.platform && g.isFullScreen())
            )
              return void g.setFullScreen(!1);
            (g.webContents.send("window-event", "close"),
              toolBar
                ? (g.blur(),
                  g.hide(),
                  "darwin" === process.platform && host.app.dock.hide())
              ...
              return p().wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      for (
                        r = a.length, o = new Array(r > 2 ? r - 2 : 0), i = 2;
                        i < r;
                        i++
                      )
                        o[i - 2] = a[i];
                    ...
                    case 4:
                      return (
                        (e.next = 6),
                        host.dialog.showMessageBox.apply(
                          host.dialog,
                          [g].concat(o),
                        )
                      );
                    ...
                    case 7:
                      return e.abrupt(
                        "return",
                        host.dialog.showOpenDialogSync.apply(
                          host.dialog,
                          [g].concat(o),
                        ),
                      );
        ...
        host.ipcMain.handle("globalShortcut", function (e, t) {
          ...
          switch (t) {
            ...
            case "unregister":
              return host.globalShortcut.unregister.apply(
                host.globalShortcut,
                r,
              );
            case "isRegistered":
              return host.globalShortcut.isRegistered.apply(
                host.globalShortcut,
                r,
              );
          }
        ...
        host.ipcMain.handle("nativeTheme", function (e, t) {
          if ("shouldUseDarkColors" === t)
            return host.nativeTheme.shouldUseDarkColors;
        }),
        host.nativeTheme.on("updated", function () {
          g.webContents.send(
            "native-theme-updated",
            host.nativeTheme.shouldUseDarkColors,
          );
        }),
        ...
        host.ipcMain.on("show-notification", function (e, t) {
          var n = M.join(global.__static, "imgs/logo_64.png"),
            notification = new host.Notification(
              b(
                b({}, t),
                {},
                {
                  icon:
                    "darwin" !== process.platform
                      ? host.nativeImage.createFromPath(n)
                      : null,
                },
              ),
            ),
      ...
      var s = function (event) {
        return host.nativeImage
          .createFromPath(
            M.join(__static, "imgs", "tray-proxy-".concat(event, ".png")),
          )
          .resize({
            width: 8,
            height: 8,
                ...
                for (;;) {
                  switch ((self.prev = self.next)) {
                    ...
                    case 5:
                      ...
                      config = l.proxies;
                      pdataOld =
                        (null == payload ? void 0 : payload.data) || {};
                      events = pdataOld.providers;
                      if (config) {
                        (sort = Object.entries(config).reduce(function (
                          env,
                          layers,
                        ) {
                        ...
                        rule = Object.entries(events).reduce(
                          function (env, owner) {
      ...
      var S = function () {
        var restoreScript;
        if (!toolBar) {
          var udataCur = host.nativeImage
            .createFromPath(M.join(__static, "imgs", "logo_64_eyes.png"))
            .resize({
              width: 24,
              height: 24,
            });
          ...
          var trayOptions = ((restoreScript = {}),
          c()(restoreScript, "win32", r20),
          c()(restoreScript, "darwin", udataCur),
          c()(restoreScript, "linux", rreturn),
          restoreScript)[process.platform];
          (toolBar = new host.Tray(trayOptions)).setToolTip(
            "Clash for Windows",
          );
          toolBar.on("right-click", function () {
            m().then(function (deepDataAndEvents) {
              toolBar.popUpContextMenu(
                host.Menu.buildFromTemplate(deepDataAndEvents),
              );
            });
          });
      ...
      (S(),
        host.ipcMain.handle("tray-create-destroy", function (dataAndEvents) {
          var method =
      ...
      function D() {
        j() &&
          toolBar &&
          toolBar.setContextMenu(language(state.language, O_EN, O_CN));
      }
      (D(),
        host.ipcMain.on("clash-core-status-change", function (e, t) {
          if (((state.isReady = !0), j())) {
            var n = language(state.language, O_EN, O_CN).getMenuItemById(
              "system-proxy",
            );
            n && (n.enabled = 1 !== t);
            var r = language(state.language, O_EN, O_CN).getMenuItemById(
              "mixin",
            );
            r && (r.enabled = 1 !== t);
            var o = language(state.language, O_EN, O_CN).getMenuItemById("tun");
            (o && (o.enabled = 1 !== t),
              ["global", "rule", "direct", "script"].forEach(function (e) {
                var n = language(state.language, O_EN, O_CN).getMenuItemById(
                  "mode-".concat(e),
                );
                n && (n.enabled = 1 !== t);
        ...
        host.ipcMain.on("enhanced-tray-click", Launch),
        host.ipcMain.on("speed-update", function (e, t, n) {
          var r =
          ...
          try {
            if (toolBar) {
              ...
              if ("win32" === process.platform) {
                if (60 === n)
                  return void (y && (y.destroy(), (y = null), (w = 0)));
                var i = o.crop({
                  x: 0,
                  y: 0,
                  width: n + 8,
                ...
                (_.writeFileSync(
                  a,
                  '\n          <body style="position:relative;background-color:'
                    .concat(
                      r,
                      ';overflow:hidden;-webkit-app-region:drag;margin:0;width:100%;height:100%;box-sizing:border-box;">\n            <img id="img" style="height:100%;width:100%;" src="',
                    )
                    .concat(
                      i.toDataURL(),
                  ...
                  y.show(),
                  y.webContents.send("speed-update-win", i.toDataURL(), r),
                  w !== n &&
                    y.setBounds({
              ...
              if ("darwin" === process.platform) {
                var u = (
                  "" === t
                    ? host.nativeImage.createFromPath(
                        M.join(__static, "imgs", "logo_64_eyes.png"),
                      )
                    : o.crop({
                        x: 0,
                        y: 0,
                          ...
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (
                                ...
                                (r = t.shell),
                                (e.next = 3),
                                r.openExternal("https://docs.cfw.lbyczf.com/")
                              );
                            case 3:
                            case "end":
                              return e.stop();
      ...
      (host.Menu.setApplicationMenu(host.Menu.buildFromTemplate(F)),
        host.ipcMain.handle("wlan-status-wanted", R));
    }
        ...
        try {
          n(354).addEventListener("wlan-status-changed", function (e, t) {
            e
              ...
              : g.webContents.send("wlan-status-changed", t);
          });
        } catch (e) {
    ...
    var E,
      z = host.app.requestSingleInstanceLock();
    ...
    (host.app.setAppUserModelId("com.lbyczf.clashwin"),
      host.app.setAsDefaultProtocolClient("clash"),
      host.app.setName("Clash for Windows"),
      host.app.setAboutPanelOptions({
        version: "",
      }),
      ...
      z
        ? (host.app.on(
            "second-instance",
            function (dataAndEvents, payload, deepDataAndEvents) {
              if (g) {
          ...
          host.app.on("ready", function () {
            (n(113).init(),
              host.powerMonitor.on("shutdown", function (e) {
                (e.preventDefault(),
                  g.webContents.send("app-exit"),
                  setTimeout(function () {
                    if (g.isMaximized) {
        ...
        : host.app.quit(),
      host.app.on("activate", function () {
        null === g ? D() : Launch();
      }),
      host.app.on(
        "certificate-error",
        ((E = l()(
          p().mark(function e(t, n, r, o, i, a) {
            var c, s;
            return p().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    ...
                    try {
                      ((s = new URL(r)),
                        (c =
                          "raw.githubusercontent.com" === s.host &&
                          "/Fndroid/ads/master/ads_v2.json" === s.path));
                    } catch (e) {}
                    if (!c && !I.includes(r)) {
                      e.next = 7;
                      break;
                  ...
                  case 7:
                    return (
                      ...
                      host.dialog.showMessageBox({
                        ...
                        message: "Failed verify the certificate for ".concat(
                          r,
                          ". This may be because the certificate is self-signed or the certificate authority is not recognized. Do you want to trust this certificate?",
                        ),
                      })
                    );
                  case 9:
                    (0 === e.sent.response &&
                      host.dialog
                        .showCertificateTrustDialog(g, {
                          certificate: i,
                          message:
                            "If you keep seeing this error, you need to go to Keychain APP to trust the certificate.",
                        })
                        .catch(function (e) {
                          console.error(e);
                        }),
